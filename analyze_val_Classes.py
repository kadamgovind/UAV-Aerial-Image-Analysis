...
OUTPUT_FILE = OUTPUT_DIR / "validation_class_distribution.csv"
...
print("=" * 55)
print("VisDrone Validation Dataset — Class Distribution")
print("=" * 55)
...
print("=" * 55)
print(f"Total valid objects: {total_annotations:,}")
